...
public class TicTacToeGUI {
	...
	private void initialize() {
		...
		btnRunServer.setBounds(264, 18, 89, 23);
		...
		btnConnect.setBounds(214, 68, 89, 34);
		...
		btnReplay.setBounds(327, 68, 89, 34);
		frame.getContentPane().add(btnReplay);
		
		JPanel panel = new JPanel();
		panel.setBounds(22, 125, 391, 179);
		...
		taLog = new JTextArea();
		taLog.setBounds(22, 319, 391, 127);
